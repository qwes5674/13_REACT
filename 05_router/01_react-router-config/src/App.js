...
//           1) function 바로 옆에 붙이면 객체로 묶어서 내보내기 떄문에
//              import할 떄 구조분해할당을 해주어야 한다.
//           2) 하단에 export default [컴포넌트 이름] 으로 사용할 때는 default로 지정하기 떄문에
...
/* 
   ...
   : 어떤 요청을 어디로 안내 및 매핑을 할 것인지를 정해놓고 진행하는 것
     리엑트에서는 요청에 따라 요청에 매핑된 컴포넌트를 랜더링 한다.
...
export default App; //export 해줘야 컴포넌트를 다른 파일에 쓸수 있다.
